...
//            : Added HTML page creation with Form and fields
//            : Added JQuery POST get all fields
...
<# 
 ...
 // Creating HTML------------------------------------------------------------------------
    WriteHtmlHeader(realEntityName);
...
void WriteHtmlHeader(string realEntityName)
{
#>
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#form-main").submit(function () {
            // Validation Failed
            if (!$("#form-main").valid()) { return false; }
